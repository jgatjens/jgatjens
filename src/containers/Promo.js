...
const content = `Ganador ${winner}`

export default () => (
  <PromoPage>
    <Head>
      <title>Ganador - {winner}</title>
      ...
      <meta name="keywords" content="Promo, twitch, jgatjens, Lol, League of Legends, Games" />
      <meta name="author" content="Ganador " />
    ...
    <div className="container">
      <Desc>Estaremos sorteando un skin de
        <a href="https://lan.leagueoflegends.com/es/" rel="noopener noreferrer" target="_blank">
          League of Legends
        </a> cada semana.
      </Desc>
      <Schedule />
      ...
      <ul>
        <li>Ser follower del stream
          <a href="https://www.twitch.tv/jgatjens" rel="noopener noreferrer" target="_blank">https://www.twitch.tv/jgatjens</a>.
        </li>
