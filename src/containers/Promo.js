...
export default () => (
  <PromoPage>
    <Head>
      ...
      <meta property="og:title" content={"Ganador " + winner} />
      ...
      <meta name="twitter:title" content={"Ganador " + winner} />
    ...
    <div className="container">
        <Desc>Estaremos sorteando un skin de <a href="https://lan.leagueoflegends.com/es/" target="_blank">League of Legends</a> cada semana.</Desc>
